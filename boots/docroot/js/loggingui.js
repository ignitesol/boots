	...
	return {
		...
		logger_selected : function(event){
			...
			if(logger_properties){
				...
				logger_properties_html = logger_properties_html + "</select></td><td><div style='width:32px;'><img src='/boots/images/back.png'  onclick='SPARX.Manage.Logging.new_data(SPARX.Manage.UI.selector_move(\"logger_"+logger_name+"_handlers\",\"available_handlers\"));'/><img src='/boots/images/next.png' onclick='SPARX.Manage.Logging.new_data(SPARX.Manage.UI.selector_move(\"available_handlers\",\"logger_"+logger_name+"_handlers\"));'/></div></td>";
				...
				logger_properties_html = logger_properties_html + "</select></td><td><div style='width:32px;'><img src='/boots/images/back.png'  onclick='SPARX.Manage.Logging.new_data(SPARX.Manage.UI.selector_move(\"logger_"+logger_name+"_filters\",\"available_filters\"));'/><img src='/boots/images/next.png' onclick='SPARX.Manage.Logging.new_data(SPARX.Manage.UI.selector_move(\"available_filters\",\"logger_"+logger_name+"_filters\"));'/></div></td>";
