...
Endpoints are building block for :ref:`Servers` and servers can have one or more endpoints of multiple types. Boots currently supports 
...
'''
from boots.common.utils import generate_uuid
